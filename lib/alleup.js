...
Alleup.prototype = {
    ...
    remove: function(file, callback, _scope, variants) {
        ...
        // possibility to pass variants as argument
        var _variants = (!!variants)? this.setupVariants(variants)  : this.setupVariants();
    ...
    setupVariants: function(variants) {
        if (!!!variants){
            ...
            //format a given variants json object
    ...
    loadConfig: function(resource) {
        ...
        // load config directly with json object as argument
